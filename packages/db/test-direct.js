async function testDirect() {
  try {
    ...
    // Test 1: Get courses with modules and level counts
    ...
    // Test 2: Get levels for a specific module
    ...
    // Test 3: Verify all modules have correct level counts
    console.log('\n3. Verifying level counts for all modules...');
    ...
    console.log(`\nTotal levels in database: ${totalLevels}`);
